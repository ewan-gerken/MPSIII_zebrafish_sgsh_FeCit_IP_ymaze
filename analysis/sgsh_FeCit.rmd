...
ggsave(filename = "sgshIPgenoproportions_figV1_narrow.svg", path = "output", width = 6, height = 6, dpi = 300)
```
...
print(emmeans(sgsh_FeCit_turns_glm_JUST_fishid, ~ genotype * treatment), type ="response") %>% 
  ...
  scale_y_continuous(limits = c(0,131), breaks = seq(0,131,10)) +
  scale_color_viridis_d(option = "inferno", end = 0.7) +
  scale_fill_viridis_d(option = "inferno", end = 0.7) +
  labs(y = "Predicted turns per time bin",
       x = "", 
...
ggsave(filename = "sgshIP_tetras_treatmentFacet_figV1.svg", path = "output", width = 12, height = 6, dpi = 300)
...
ggsave(filename = "sgshIPmodel_combinedaltsV2.svg", path = "output", width = 6, height = 6, dpi = 300)
...
print(emmeans(sgsh_FeCit_glm_reps, ~ genotype * treatment), type = "response") %>% 
  ...
  scale_y_continuous(limits = c(0,0.39), breaks = seq(0,0.39,0.025)) +
  scale_color_viridis_d(option = "inferno", end = 0.7) +
  scale_fill_viridis_d(option = "inferno", end = 0.7) +
...
ggsave(filename = "sgshIPmodel_combinedrepsV2.svg", path = "output", width = 6, height = 6, dpi = 300)
